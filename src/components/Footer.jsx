      ...
      <footer className="bg-white dark:bg-gray-900">
          <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
              <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="/" className="flex items-center">
                        {/* <img src="/assets/images/logo.png" className="h-40 me-3" alt="FlowBite Logo" /> */}
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ReRead</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 text-base">
                            ...
                            <li>
                                <a href="#" className="hover:underline">ReRead Teleport</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="#" className="hover:underline"> Listing Policy </a>/
                                <a href="#" className="hover:underline"> Privacy Policy </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">ReRead™</a>. All Rights Reserved.
                </span>
